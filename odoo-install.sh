#!/bin/bash
################################################################################
# This is only for installing odoo on ubuntu 18.04 and without enterprise based on the 
...
sudo git clone --depth 1 --branch $OE_VERSION https://www.github.com/oca/website $OE_HOME/custom/addons/website
sudo git clone --depth 1 --branch $OE_VERSION https://www.github.com/oca/web $OE_HOME/custom/addons/web
sudo git clone --depth 1 --branch $OE_VERSION https://www.github.com/oca/server-tools $OE_HOME/custom/addons/server-tools
...
sudo su root -c "printf 'addons_path=${OE_HOME_EXT}/addons,${OE_HOME}/custom/addons,${OE_HOME}/custom/addons/website,${OE_HOME}/custom/addons/web,${OE_HOME}/custom/addons/server-tools,${OE_HOME}/custom/addons/helpdesk\n' >> /etc/${OE_CONFIG}.conf"
# For nginx needs to enable multi process
